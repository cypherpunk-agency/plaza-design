...
|-------|----------------|
| [Philosophy](./01_philosophy.md) | The soul — what Plaza *feels* like |
| [Hierarchy](./02_hierarchy.md) | Interactive vs decorative — when to use what |
| [Color](./03_color.md) | Palette, semantics, glow effects |
| [Typography](./04_typography.md) | Font scale, weights, spacing |
| [Language](./05_language.md) | Voice & tone — how the terminal speaks |

## Dev Guide

| Guide | What It Covers |
|-------|----------------|
| [Theming](./07_theming.md) | Built-in themes and custom themes |
| [Text Colors](./11_text-colors.md) | Semantic text color variables |
| [Markdown](./10_markdown.md) | Content formatting and rendering |
